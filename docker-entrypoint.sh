...
window.__RUNTIME_CONFIG__ = {
  ...
  VITE_APP_TITLE: '${VITE_APP_TITLE:-WebTrit}',
  ...
  VITE_SHARE_IMAGE_URL: '${VITE_SHARE_IMAGE_URL}',
  VITE_BRAND_NAME: '${VITE_BRAND_NAME:-WebTrit}',
  VITE_LOGO_URL: '${VITE_LOGO_URL:-/favicon.png}',
  VITE_TERMS_URL: '${VITE_TERMS_URL:-https://webtrit.com/legal/terms-of-use/}',
  VITE_SUPPORT_EMAIL: '${VITE_SUPPORT_EMAIL:-contact@webtrit.com}',
  VITE_BRAND_COLOR: '${VITE_BRAND_COLOR:-#5CACE3}',
  VITE_BRAND_COLOR_STRONG: '${VITE_BRAND_COLOR_STRONG:-#1F4799}',
  VITE_BRAND_COLOR_SUBTLE: '${VITE_BRAND_COLOR_SUBTLE:-#EBF5FF}'
};
EOF
